...
// アンケートの選択内容を格納するリスト
//var questionList = [];
function createQuestion (spinner) {
	...
	var div = $('<div>').attr({id:"question"+qfn,name:"question",qfn:qfn}).draggable({
		stop:function(e,ui){
			...
			var questionObj = {id:$(this).attr('id'),qfn:Number($(this).attr('qfn')),spinner:spinner,question:{top:$('#question'+$(this).attr('qfn')+'-1').offset().top,left:$('#question'+$(this).attr('qfn')+'-1').offset().left},submit:{top:$('#qSubmit'+$(this).attr('qfn')).offset().top,left:$('#qSubmit'+$(this).attr('qfn')).offset().left}};
	...
	var questionObj = {id:$('#question'+qfn).attr('id'),qfn:qfn,spinner:spinner,question:{top:$('#question'+qfn+'-1').offset().top,left:$('#question'+qfn+'-1').offset().left},submit:{top:$('#qSubmit'+qfn).offset().top,left:$('#qSubmit'+qfn).offset().left}};
	jsonObj["questions"].push(questionObj);

	//var text = '{"question'+qfn+'":{"qfn":"'+qfn+'","spinner":"'+spinner+'",question'+qfn+'":{"top":"'+$('#question'+qfn).offset().top+'","left":"'+$('#question'+qfn).offset().left+'"},"question'+qfn+'-1":{"top":"'+$('#question'+qfn+'-1').offset().top+'","left":"'+$('#question'+qfn+'-1').offset().left+'"},"qSubmit'+qfn+'":{"top":"'+$('#qSubmit'+qfn).offset().top+'","left":"'+$('#qSubmit'+qfn).offset().left+'"}}}';
	//console.log(jsonObj);
